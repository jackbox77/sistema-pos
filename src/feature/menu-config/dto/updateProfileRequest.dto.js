...
export function createUpdateProfileRequest(params = {}) {
  ...
  if (params.menu_config != null) {
    ...
    body.menu_config = {
      ...
      // Colores: incluir siempre que estén definidos (incluye '') para que el backend los persista
      ...(mc.menu_background_color !== undefined && { menu_background_color: mc.menu_background_color }),
      ...(mc.content_background_color !== undefined && { content_background_color: mc.content_background_color }),
      ...(mc.text_color !== undefined && { text_color: mc.text_color }),
      ...(mc.title_color !== undefined && { title_color: mc.title_color }),
      ...(mc.subtitle_color !== undefined && { subtitle_color: mc.subtitle_color }),
      ...(mc.price_color !== undefined && { price_color: mc.price_color }),
      ...(mc.accent_color !== undefined && { accent_color: mc.accent_color }),
      ...(mc.contact_icon_color !== undefined && { contact_icon_color: mc.contact_icon_color }),
      ...(mc.contact_text_color !== undefined && { contact_text_color: mc.contact_text_color }),
      ...(mc.contact_background_color !== undefined && { contact_background_color: mc.contact_background_color }),
      ...(mc.menu_background_image !== undefined && { menu_background_image: mc.menu_background_image }),
      ...(mc.header_background_image !== undefined && { header_background_image: mc.header_background_image }),
    }
